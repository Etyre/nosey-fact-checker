...
- **Hotkeys**: text like `ctrl+alt+j`, `shift+cmd+space`, `ctrl+alt+f9`. The dismiss hotkey (default `ctrl+alt+k`) clears Nosey's notifications; set the alert style to Alerts in System Settings if you want them to stay until dismissed.
